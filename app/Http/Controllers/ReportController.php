...
{   
    /**
     * Display the logged time sum report.
     */
    ...
    /**
     * Display the daily logged time report.
     */
    ...
    /**
     * Display the Earned value management projects report.
     */
    public function earnedValueManagementProjects(Request $request): Response
    {
        Gate::allowIf(fn (User $user) => $user->can('view earned value management projects report'));

        $items = DB::table('projects')
            ->join('tasks', 'tasks.project_id', '=', 'projects.id')
            ->join('time_logs', 'time_logs.task_id', '=', 'tasks.id')
        ...
        return Inertia::render('Reports/EarnedValueManagementProjects', [
            'items' => $items,
            'dropdowns' => [
                'projects' => Project::dropdownValues(),
                'users' => User::userDropdownValues(),
