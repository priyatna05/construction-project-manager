    ...
    public function index(): Response
    {
        ...
        return Inertia::render('Dashboard/Index', [
            ...
            'overdueTasks' => Task::whereIn('project_id', $projectIds)
                ...
                ->with('project:id,name_project')
                ->with('taskGroup:id,name_group')
                // ->orderBy('due_on')
                ->get(['id', 'name_task', 'group_id', 'project_id']),
            'recentlyAssignedTasks' => Task::whereIn('project_id', $projectIds)
                ...
                ->orderBy('assigned_at')
                ->limit(10)
                ->get(['id', 'name_task', 'assigned_at', 'group_id', 'project_id']),
            'recentComments' => Comment::query()
                ...
                ->with([
                    'task:id,name_task,project_id',
                    'task.project:id,name_project',
                    'user:id,name',
                ])
                ->latest()
                ->get(),
