...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::group(['prefix' => 'projects', 'as' => 'projects.'], function () {
        ...
        Route::post('{projectId}/delete', [ProjectController::class, 'destroy'])->name('delete');
        Route::put('{project}/favorite/toggle', [ProjectController::class, 'favoriteToggle'])->name('favorite.toggle');
        Route::post('{projecst}/user-access', [ProjectController::class, 'userAccess'])->name('user_access');
        ...
        // TIME LOGS adding some EvM Analitics
        Route::group(['prefix' => '{project}/tasks/{task}', 'as' => 'tasks.'], function () {
