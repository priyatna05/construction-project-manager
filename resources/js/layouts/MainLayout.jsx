...
export default function MainLayout({ children, title }) {
  ...
  return (
    ...
    >
      ...
      <FlashNotification />
        <SearchInput renderTriger={({ onClick }) =>(
          <Affix position={{bottom: 10, left: 27 }} zIndex={1000}>
          <Button
           radius="xl"
           size="md"
           variant="filled"
      ...
      <AppShell.Navbar className="navbar" pl="md" pt="md" pb="md">
        <Group justify={collapsed ? "center" : "space-between"} p="xs" gap="xs">
